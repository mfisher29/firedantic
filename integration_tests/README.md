...
This folder contains integration test files. This README explains how to run them and
...
- `integration_tests/test_integration_all.py` - Purpose: intended to run all examples
  shown in the readme, new and legacy.

## How to run

Run each individual test file: - `python configure_firestore_db_clients.py` -
`python full_sync_flow.py` - `python full_async_flow.py` -
